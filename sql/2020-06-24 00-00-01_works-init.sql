...
CREATE TABLE `role_authority_relationship` (
  ...
  `auth_id` smallint(6) DEFAULT NULL COMMENT '权限ID',
...
CREATE TABLE `sys_authority` (
  `auth_id` smallint(6) NOT NULL COMMENT '权限ID',
...
CREATE TABLE `sys_org_user` (
  `user_id` bigint(20) NOT NULL COMMENT '机构用户ID',
  `top_id` bigint(20) DEFAULT NULL COMMENT '顶级机构ID',
...
CREATE TABLE `sys_organization` (
  ...
  `top_id` bigint(20) DEFAULT 0 COMMENT '顶级机构ID',
  `parent_id` bigint(20) DEFAULT 0 COMMENT '父级机构ID',
  `org_level` tinyint(4) DEFAULT NULL COMMENT '层级(从0开始,最大5级)',
...
CREATE TABLE `work_next_plan` (
  ...
  `top_id` bigint(20) DEFAULT NULL COMMENT '顶级机构ID',
  `user_id` bigint(20) DEFAULT NULL COMMENT '用户ID',
  `plan_text_id` bigint(20) DEFAULT NULL COMMENT '计划内容ID',
  `updater` bigint(20) DEFAULT NULL,
  `creator` bigint(20) DEFAULT NULL,
  `update_time` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `create_time` timestamp NOT NULL DEFAULT current_timestamp(),
...
CREATE TABLE `work_plan_text` (
  `plan_text_id` bigint(20) NOT NULL COMMENT '计划内容ID',
  `org_id` bigint(20) DEFAULT NULL COMMENT '机构ID',
  `top_id` bigint(20) DEFAULT NULL COMMENT '顶级机构ID',
  `plan` varchar(64) DEFAULT NULL COMMENT '明天计划',
  `total` smallint(6) DEFAULT 1 COMMENT '激活次数',
  `updater` bigint(20) DEFAULT NULL,
  `creator` bigint(20) DEFAULT NULL,
  `update_time` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `create_time` timestamp NOT NULL DEFAULT current_timestamp(),
